...
def parse_args():
    ...
    # Fixed KNN hyperparameters

    parser.add_argument("--knn-neighbors", default=11, type=int)

    parser.add_argument("--knn-metric", default="cosine", type=str)

    parser.add_argument("--knn-weights", default="distance", type=str)
...
def evaluate_knn(name, x_train, y_train, x_test, y_test, n_neighbors, metric, weights):
    ...
    print(f"KNN metric: {metric}")

    print(f"KNN weights: {weights}")
...
def main():
    ...
    # KNN은 거리 기반 모델이므로 scaling을 적용한다.
